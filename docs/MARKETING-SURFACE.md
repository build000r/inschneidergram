...
| "Delivery and reply reporting" | Partly true | Provider events, non-simulated executions, and manual evidence dispatch signed runtime callbacks by default; live provider integration still pending. |
