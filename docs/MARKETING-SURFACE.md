...
| "Launch authorization gate" | True for MVP scope | Manual and managed-provider executions require a fresh, evidence-backed authorization object and preserve it in proof exports; mock demos remain exempt. |
